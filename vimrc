...
" plugin/mapping configuration {{{
  ...
  if count(s:settings.plugin_groups, 'web') "{{{
    ...
    call dein#add('cakebaker/scss-syntax.vim', {'lazy': 1, 'on_ft':['scss','sass']})
    call dein#add('hail2u/vim-css3-syntax', {'lazy': 1, 'on_ft':['css','scss','sass']})
    call dein#add('ap/vim-css-color', {'lazy': 1, 'on_ft':['css','scss','sass','less','styl']})
    call dein#add('othree/html5.vim', {'lazy': 1, 'on_ft':['html']})
    call dein#add('wavded/vim-stylus', {'lazy': 1, 'on_ft':['styl']})
    call dein#add('digitaltoad/vim-jade', {'lazy': 1, 'on_ft':['jade']})
    call dein#add('juvenn/mustache.vim', {'lazy': 1, 'on_ft':['mustache']})
    call dein#add('gregsexton/MatchTag', {'lazy': 1, 'on_ft':['html','xml']})
    call dein#add('mattn/emmet-vim', {'lazy': 1, 'on_ft':['html','xml','xsl','xslt','xsd','css','sass','scss','less','mustache']}) "{{{
  ...
  if count(s:settings.plugin_groups, 'javascript') "{{{
    ...
    call dein#add('maksimr/vim-jsbeautify', {'lazy': 1, 'on_ft':['javascript']}) "{{{
    ...
    call dein#add('mmalecki/vim-node.js', {'lazy': 1, 'on_ft':['javascript']})
    call dein#add('leshill/vim-json', {'lazy': 1, 'on_ft':['javascript','json']})
    call dein#add('othree/javascript-libraries-syntax.vim', {'lazy': 1, 'on_ft':['javascript','coffee','ls','typescript']})
  endif "}}}
  ...
  if count(s:settings.plugin_groups, 'python') "{{{
    call dein#add('klen/python-mode', {'lazy': 1, 'on_ft':['python']}) "{{{
      let g:pymode_rope=0
    "}}}
  ...
  if count(s:settings.plugin_groups, 'go') "{{{
    ...
    call dein#add('jnwhiteh/vim-golang', {'lazy': 1, 'on_ft':['go']})
    call dein#add('nsf/gocode', {'lazy': 1, 'on_ft':['go'], 'rtp': 'vim'})
  endif "}}}
  ...
  if count(s:settings.plugin_groups, 'windows') "{{{
    call dein#add('PProvost/vim-ps1', {'lazy': 1, 'on_ft':['ps1']}) "{{{
      autocmd BufNewFile,BufRead *.ps1,*.psd1,*.psm1 setlocal ft=ps1
    "}}}
    call dein#add('nosami/Omnisharp', {'lazy': 1, 'on_ft':['cs']})
  endif "}}}
"}}}
...
" color schemes {{{
  ...
  call dein#add('CruizeMissile/Revolution.vim')
